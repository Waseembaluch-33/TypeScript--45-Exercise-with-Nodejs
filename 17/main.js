...
var guestList = ["Waseem", "Hasinain", "Haseeb", "Haider"];
...
guestList.forEach(function (oneGuest) { return console.log("Asslamualikum ".concat(oneGuest, " Would you Like to Dinner With me")); });
//inform that only two guest can be invited for Dinner
console.log("Unfortunately, the new dinner table wont arrive on time, so i can only invite two Guests to Dinner with me");
//using while-Loop to remove Guests From the Array until only two Names remain
while (guestList.length > 2) {
    var removeGuest = guestList.pop();
    console.log("Sorry ".concat(removeGuest, " I Cant Invite To Dinner"));
}
//Sending a invitation last Two Guest on the List
console.log("Invitation to the last Two Guest");
guestList.forEach(function (lastTwo) { return console.log("Luckly ".concat(lastTwo, " You Are Stille Invited To Dinner")); });
